...
// <coopordie> Internal functions for compute the codlayout data
//==================
// 
//==================
int entArmor(edict_t *ent)
{
	gitem_t		*item;
...
// <coopordie> CoopScoreboardMessage (cooperative layout for COOP or DIE)
//==================
// Display a layout for cooperative play
//==================
#define RANGE_1_METER    39         // 1 meter in map unit
void CoopScoreboardMessage(edict_t *ent)
{
	gclient_t	*cl;
	edict_t		*cl_ent;
	char	string[1400];
	...
	for (i=0 ; i<game.maxclients ; i++)
	{
		...
		if ( challengemode->value == 1 )
		{
			j = strlen(string) ;
			Com_sprintf (string+j, sizeof(string)-j,
				"xr -%i yt %i picn \"challenge\" ",		// challenge mode
				x,    y+20) ;
		}
...
void DeathmatchScoreboardMessage (edict_t *ent, edict_t *killer)
{
	...
	// <coopordie> DeathmatchScoreboardMessage : call of CoopScoreboardMessage
	if ( coop->value )
	{
